document.addEventListener('DOMContentLoaded', () => {
    // --- URLs da API ---
    const UPDATE_USER_API_URL = 'https://bling-proxy-api-255108547424.southamerica-east1.run.app/auth/update-user';
    const GET_ALL_USERS_API_URL = 'https://bling-proxy-api-255108547424.southamerica-east1.run.app/auth/get-all-users';
    ...
    function checkAuth() {
        ...
        if (token) {
            ...
            // CORREÇÃO: Espera a função window.startApp ser definida antes de chamá-la.
            // Isso resolve o problema do conteúdo não carregar após o login.
